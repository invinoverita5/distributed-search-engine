...
class RequestImpl implements Request {
  ...
  byte bodyRaw[];
  Server server;
  Session currentSession = null;  // Cached session for this request
  ...
  public Session session() {
    ...
    // Ask the server to get or create a session for this request
    currentSession = server.getOrCreateSession(this);
    return currentSession;
  }
}
